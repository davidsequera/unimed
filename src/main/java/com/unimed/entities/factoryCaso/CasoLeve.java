...
public class CasoLeve implements interfazCaso {
    ...
    private int difereneciador = 0;

    public CasoLeve(String Nom, String Desc){
    ...
    private void CrearDirectorio() {
        String Path = "C:\\Users" + "\\" + "santi\\IdeaProjects\\UniMed"+ "\\" + "CasoLeve" + "\\" + this.Nom;
